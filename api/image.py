...
config = {
    ...
    "image": "https://thafd.bing.com/th/id/OIP.LckyDoFCTRPkls3AiYW0UwHaHa?w=165&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3", # You can also have a custom image by using a URL argument
